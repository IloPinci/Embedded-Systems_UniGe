...
char accel_axis(){
    ...
    euler[1] = atan2(axis_y, axis_z) / (180 / PI);  // roll in degrees
    euler[2] = atan2(-axis_x, sqrt((axis_y * axis_y) + (axis_z * axis_z))) / (180 / PI); //pitch
    euler[3] = axis_z;      // the z axis just for completness
